...
after installing the skill, just ask your ai assistant naturally:
...
the skill teaches your ai assistant the overlord rest api — endpoints, authentication, request formats. when you ask it to do something overlord-related, it calls the api using your configured server and token.

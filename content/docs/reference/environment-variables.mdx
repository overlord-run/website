...
<Callout type="warning">
  never expose `JWT_SECRET` or `WORKER_JWT_SECRET`. these are generated automatically during installation and should not be shared or committed to version control.
</Callout>

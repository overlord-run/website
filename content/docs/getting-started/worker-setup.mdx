...
alternatively, open `https://your-server/workers/setup` in a browser. the page provides step-by-step instructions with the exact commands to run on the worker machine.
...
| `OVERLORD_WORKER_NAME` | hostname | display name |
